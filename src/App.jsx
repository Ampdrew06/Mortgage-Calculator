  ...
  return (
    <div className="container">
      <div className="header">
        ...
        <button className="share-btn" onClick={() => setShowInfo(!showInfo)} title="App Info">ℹ️</button>
      </div>
      ...
      {showInfo ? (
        <div className="info-section">
          <h2>Input Guide</h2>
          <ul>
            <li><strong>Loan Amount:</strong> Total mortgage value</li>
            <li><strong>Initial Rate:</strong> Introductory interest rate (if any)</li>
            <li><strong>Loan Term:</strong> Total mortgage length in years</li>
            <li><strong>Fixed Term:</strong> Length of fixed-rate period (if any)</li>
            <li><strong>Secondary Rate:</strong> Rate after the fixed term ends</li>
            <li><strong>Overpayment:</strong> Monthly overpayments you'd like to make</li>
            <li><strong>Target Years:</strong> Your goal to pay off early (optional)</li>
          </ul>
          <h2>Disclaimer</h2>
          <p>This is an illustrative tool only. Results are estimates and do not constitute financial advice. Please consult a qualified advisor before making decisions.</p>
        </div>
      ) : (
        <>
          ...
          <div className="input-row">
            ...
            <input type="number" inputMode="decimal" step="0.01" value={initialRate} onChange={(e) => setInitialRate(e.target.value)} />
          ...
          <div className="input-row">
            ...
            <input type="number" inputMode="decimal" step="0.01" value={secondaryRate} onChange={(e) => setSecondaryRate(e.target.value)} />
            <button className="clear-btn" onClick={() => setSecondaryRate('')}>Clear</button>
          </div>

          <div className="input-row">
            <label>Overpayment (£) (Optional)</label>
            <input type="number" inputMode="decimal" step="0.01" value={overpayment} onChange={(e) => setOverpayment(e.target.value)} />
